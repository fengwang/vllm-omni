...
Verifies the Session-4 wiring that serves the weight-only nvfp4_blockwise_mixed_v1
...
Scenario source: docs/session_4/specs/nvfp4-native-fp4-resident-loading.md.
"""
