...
The checkpoint format under test (Session 3 `nvfp4_blockwise_mixed_v1`): per
...
the target modules remain FP4-resident. Scenarios:
docs/session_4/specs/{nvfp4-native-fp4-resident-loading,
nvfp4-checkpoint-integrity-verification}.md of cosmos3-nano-webui.
"""
